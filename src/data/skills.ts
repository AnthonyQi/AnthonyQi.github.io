...
export const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: "C#", level: "intermediate", since: "2023", description: "Learned C# through game development. First time being my participation in CMU's National High School Game Academy, where I spent six weeks building 2 games with 2 different teams. Since then, I have done some game development both in and out of school using Unity with C#" },
      ...
      { name: "SQL", level: "intermediate", since: "2024", description: "Learned and Utilized SQL in highschool for a cybersecurity course. Since then, I haven't really used SQL but am attempting to relearn for a future project in mind" },
    ],
  },
  {
    id: "02",
    ...
    skills: [
      { name: "Compilers", level: "intermediate", since: "2026", description: "Learned how to build a compiler in OCaml through a college course, understanding programming languages work through the multiple stages a compiler uses to check for syntax, semantics, and functionality." },
      { name: "Systems Programming", level: "intermediate", since: "2025", description: "Systems programming was definitely hard to grasp at first but understanding how shellacs work, or how malloc handles memory was very intriguing."},
      { name: "Multithreading", level: "proficient", since: "2025", description: "Working with languages like C, Java and all sorts of other languages, multithreading for tasks, especially ones with thousands upon thousands of smaller tasks, helps with the overall efficiency"},
      ...
      { name: "Garbage Collection", level: "intermediate", since: "2026", description: "After learning about memory management, naturally comes learning about how that memory gets wiped. Understanding Garbage collectors works best with a project in Rust where it doesn't automatically do the garbage collecting" },
      { name: "Data Structures & Algorithms", level: "advanced", since: "2020", description: "Since my first exposure to Java, I have since learned so much about the different data structures and algorithms. Learning how and when to use certain algorithms to solve problems, and furthermore, how and when to use different data structures to build those algorithms." },
    ],
  },
  {
    id: "03",
    ...
    skills: [
      ...
      { name: "Bash", level: "amateur", since: "2024", description: "Learned to use bash in a cyber security class, and has since used and learned about it in my intro to computer systems class."},
      ...
      { name: "GDB", level: "intermediate", since: "2025", description: "While working with lower level languages and learning about systems programming, I learned about GDB for debugging. Immensely useful to look at code, especially line by line for languages like assembly." },
      { name: "Valgrind", level: "intermediate", since: "2025", description: "Paired with GDB, understanding how to use Valgrind helped a lot to learn and understand about memory leaks/management."},
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Machine Learning", level: "intermediate", since: "2024", description: "Got into ML through lego robotics as a kid. Eventually cofounding ROAR (Robot Open Autonomous Racing) as a club through Berkeley's sponsorship. Most of my experience with machine learning are purely theory right now, though I intend to get more into hands-on work." },
