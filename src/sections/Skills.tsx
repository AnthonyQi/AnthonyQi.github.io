...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-20 px-6 max-w-5xl mx-auto">
      ...
      />
      <div
        className={`grid sm:grid-cols-2 md:grid-cols-4 gap-px bg-border border border-border transition-all duration-500 ${
          revealed
      ...
      >
        {SKILL_GROUPS.map((group) => {
          ...
          return (
            <div
              key={group.id}
              className="bg-card/40 backdrop-blur-sm p-6"
            >
